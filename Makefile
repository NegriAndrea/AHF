...
ahfCheckSubhalos:	FORCE dirs
		cd tools;\
		${MAKE} ahfCheckSubhalos;\
		mv -f ahfCheckSubhalos ../bin
...
ahfHaloHistoryStats:			FORCE dirs
		cd analysis;\
		${MAKE} ahfHaloHistoryStats;\
		mv -f ahfHaloHistoryStats ../bin
